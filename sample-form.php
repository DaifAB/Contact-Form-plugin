<?php
/*
Plugin Name: Sketchy Contact Form
...
//L'envoi des informations au base de donnée 
    ...
    function addMenu()
    {
        add_menu_page("Sketchy Contact Form", "Sketchy Contact Form", 4, "Sketchy Contact Form", "adminMenu");
    }
...
function adminMenu()
{
    ...
    <center><h1 style="color:red; font-family : monospace;">
      Sketchy Contact Form by Sketch
    </h1></center>
